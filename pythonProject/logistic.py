...
Model = RandomizedSearchCV(estimator=LogisticRegression(random_state=123),
...
#把最优参数保存导出#
with open(r'Model\Best_param_logistic.json', 'w') as f:
    json.dump(Model.best_params_, f)
model = Model.best_estimator_

# 保存模型
with open(r'Model\logistic_model.pkl', 'wb') as f:
    pickle.dump(model, f)
