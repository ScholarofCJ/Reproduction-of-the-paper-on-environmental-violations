...
def plot_gam_style_from_shap(feature_x_std, feature_x_orig, shap_y, feature_name, plot_label, output_dir, colors,feature_mean, feature_std):
    ...
    ax.text(
        0.05, 0.9,
        rf'Explained deviance = {explained_deviance:.3f}',
...
if __name__ == '__main__':
    ...
    # =====================================4.数据得输入、结果输出设置=========================================
    # =========================================================================================
    # excel_path = r"C:\Users\12109\OneDrive\xwechat_files\wxid_8a1v9uctarek22_d3eb\msg\file\2026-01\simulated_regression_data.xlsx"  # 输入数据的路径。
    output_dir = r'E:\公众号素材\带有渐变颜色的单因子柱状图\results'  # 输出结果
    os.makedirs(output_dir, exist_ok=True)  # 如果不存在就创建
    df = pd.read_excel('Data完整.xlsx')
