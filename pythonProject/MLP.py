...
# 开始对模型进行优化，调整参数
param_distributions = {
    'hidden_layer_sizes': [(50, 50, 50), (50, 100, 50), (100,), (100, 100), (150, 100, 50)],
...
Model = RandomizedSearchCV(estimator=MLPClassifier(max_iter=100, random_state=123),
...
#把最优参数保存导出#
with open(r'Model\Best_param_mlp.json', 'w') as f:
    json.dump(Model.best_params_, f)
model = Model.best_estimator_

# 保存模型
with open(r'Model\mlp_model.pkl', 'wb') as f:
    pickle.dump(model, f)
